...
type CLI struct {
	...
	WebListenAddr string           `name:"web.listen-address" env:"WHITEBOX_LISTEN_ADDRESS" default:":9116" help:"Address to listen on for the exporter, either [host]:port or a bare port."`
